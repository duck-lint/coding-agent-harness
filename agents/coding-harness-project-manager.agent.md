...
- next admissible move: the least expansive transformation that truthfully reduces that tension, names affected and non-affected surfaces, preserves future optionality, and stays inside current invariant and task authority
...
- tension selection: is the recommended action tied to the most important actionable mismatch between current posture and desired outcomes, not merely the easiest available task?
